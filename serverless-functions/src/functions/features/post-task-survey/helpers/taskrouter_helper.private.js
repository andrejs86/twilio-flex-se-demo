exports.taskDetailsFromConversationSid = async (client, workspaceSid, conversationSid) => {
...
exports.agentNameFromIdentity = async (client, workspaceSid, agentIdentity) => {
  ...
  const workers = await client.taskrouter.v1.workspaces(workspaceSid).workers.list({ friendlyName: agentIdentity });
